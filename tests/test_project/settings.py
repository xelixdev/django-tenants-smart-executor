...
SECRET_KEY = "django-insecure-x*ys6wq9*(*)f&u=0q&8u=kc50mgvjqvsbvf=xemkzu(alffkl"
...
SHARED_APPS = [
    ...
    "django_tenants",
    "tests.test_project.public_app",
]
TENANT_APPS = ["django.contrib.contenttypes", "tests.test_project.tenant_app"]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "platform"),
